...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    if ( is_singular() AND comments_open() AND (get_option('thread_comments') == 1)) {
      ...
      wp_register_script( 'masonry', get_stylesheet_directory_uri() . '/library/js/libs/masonry.min.js', array( 'jquery' ), '', true );
      wp_register_script( 'infinite-scroll', get_stylesheet_directory_uri() . '/library/js/libs/infinitescroll.min.js', array( 'jquery' ), '', true );
